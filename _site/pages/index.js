        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            ...
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Welcome to ${siteMetadata.description}. I am a Cyber Security Student who is passionate about Cyber Security and CTF events. In my free time, I like playing `}
              CTF event and learning new technologies.
            </h2>
            ...
            <p className="hidden pt-10 text-lg leading-7 text-slate-600 dark:text-slate-300 md:block">
              ...
              <div className="mt-8 text-slate-600 dark:text-slate-400">
                ...
                <video
                  ...
                  src="D:\blog\public\static\images\gif.mp4"
                ></video>
              </div>
            </p>
          </div>
